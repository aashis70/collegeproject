...
$connection_error = 'could not connect';
	...
	$mysqlConnect = mysqli_connect('localhost', 'root','');
...
<div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				<li><a href="http://localhost/medicio/home.php">Home</a></li>
				 <li class="active"> <a href="http://localhost/sample/medicio/image.php">Cost Details</a>
	...
	<h2>Updated Rate List of available Laboratory Test at Cosmos Medical Group</h2>
				
<div> 
	<img src="projectimage/2.jpg" height="650px" width="75%">
</div>
<div>
	<img src="projectimage/3.jpg" height="650px" width="75%">
</div>
<div>
	<img src="projectimage/4.jpg" height="650px" width="75%">
</div>
