<?php 
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		$userid = $_POST["first_name"];
		$userdata = $_POST["last_name"];
		$email=$_POST["email"];
		$phone=$_POST["phone"];
		if($userid==null)
		{
		...
		$qry = "insert into appointment(first_name, last_name,email,phone)
				values('$userid', '$userdata','$email','$phone');";
		$res = $conn->query($qry);
		if($res)
		{
			$msg = "*Appointment Successful, We'll contact you by phone or email later";
        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li class="active"><a href="http://localhost/medicio/index.php">Make Your Appointment</a></li>
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<form role="form" class="lead" action="index.php" method="post">
										<div class="row">
