    ...
    <div class="top-area">
      <div class="container">
        <div class="row">
          ...
          <p class="bold text-left">Latest Report Details</a> </p>
          </div>
          <div class="col-sm-6 col-md-6">
            <p class="bold text-right"><a href="adminhome.php"><input type="button" value="Back"></p>
...
<body>
 <table align="center" border="1px" style="width:1200px; line-height:40px;">
  <tr>
  <th colspan="6"><h2>Latest Report Records</h2></th>
  </tr>
  <t>
    <th>Email</th>
