    ...
    <div class="top-area">
      <div class="container">
        <div class="row">
          ...
          <p class="bold text-left">User Registration Details     </a> </p>
          </div>
          <div class="col-sm-6 col-md-6">
...
<body>
 <table align="center" border="1px" style="width:1200px; line-height:40px;">
  ...
  while($rows=mysqli_fetch_assoc($result)){ ?>
    <tr>
      <td><?php echo $rows['full_name']; ?></a></td>
      <td><?php echo $rows['address']; ?></td>
      <td><?php echo $rows['contact_number']; ?></td>
      <td><?php echo $rows['email']; ?></td>
      <td><?php echo $rows['password']; ?></td>
      <td><?php echo $rows['password1']; ?></td>
      <td><a class="btn btn-success" href="register.php?id=' . $row['id'] . '">Edit</a></td>;
      <td><a class="btn btn-red" href="delete.php?id=' . $row['id'] . '">Delete</a></td>;
    </tr>
    <?php 
    } ?>
</table>
